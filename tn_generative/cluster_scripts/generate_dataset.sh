...
#SBATCH --mem=50000
#SBATCH -c 1
#SBATCH --array=0-29 # 30 different parameter settings 
...
package_path="/n/home11/yteng/tn-shadow-qst/tn_generative/"
cd ${package_path}
FILEPATH="/n/home11/yteng/experiments/TNS"
data_dir="$FILEPATH/dataTNS/"
mkdir -p ${data_dir}
echo "Data saving directory is ${data_dir}"
echo "array_task_id=${SLURM_ARRAY_TASK_ID}"
{
python run_data_generation.py 
--data_config="${package_path}data_configs/surface_code_data_config.py" 
